  ...
  return (
    <>
      ...
      <section className="products hero w-full h-[200dvh] relative">
        ...
        <div className="content w-full min-h-[100dvh] max-h-[fit-content] flex justify-center flex-col gap-y-8 text-wrap px-12 base:px-32 xl:px-48 py-3 absolute z-[10]">
          <Fade cascade triggerOnce={true}>
            ...
            <div className="action-links flex flex-row gap-x-5">
              <Link className="text-[13px] text-black bg-white px-[18px] py-[9px] font-[550] rounded-lg border border-white hover:bg-transparent transition-all ease-in-out duration-300 hover:text-white">
                <span>For Android</span>
              </Link>
              <Link
                to={"/products"}
                className="text-[13px]  text-white bg-primary-600 px-[28px] py-[9px] font-[550] rounded-lg border border-primary-600 hover:bg-transparent transition-all ease-in-out duration-300 hover:text-white"
              >
                <span>For IOS</span>
              </Link>
            </div>
